...
?>
<div class="section_header-brand">
	<div class="padding-global"><div class="container-large"><div class="padding-section-none kndsb-header__brand"><a class="kndsb-header__brand-link" href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home">
		<?php if ( $logo['url'] ) : ?>
